  ...
  return (
    <div className='w-screen box-border'>
      ...
      <section className='w-screen  bg-gray-200 text-slate-800 py-10'>
        <h2 className="md:text-4xl text-2xl text-center font-bold mb-10">Why Reducing Website Emissions Matters</h2>
        <div className='flex md:flex-row flex-col w-11/12 mx-auto items-center justify-evenly px-5 *:my-3'>
          <p className="md:text-lg text-justify md:w-1/3">

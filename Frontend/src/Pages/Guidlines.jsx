...
const Guidlines = () => {
    ...
    return (
        <section id="guidelines" className="py-10 px-6 bg-gray-100">
            <h2 className="text-5xl font-bold text-gray-800 text-center mb-8">Guidelines for Reducing CO2 Emissions in Your Project</h2>
